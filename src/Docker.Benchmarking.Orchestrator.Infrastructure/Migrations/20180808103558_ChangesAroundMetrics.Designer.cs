...
namespace Docker.Benchmarking.Orchestrator.Infrastrcture.Migrations
{
    ...
    [Migration("20180808103558_ChangesAroundMetrics")]
    partial class ChangesAroundMetrics
    {
            ...
            modelBuilder.Entity("Docker.Benchmarking.Orchestrator.Core.Entities.CloudProvider", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("e966a5f8-66dc-4434-9942-07fd884bfe68"), DateTimeCreated = new DateTimeOffset(new DateTime(2018, 8, 8, 10, 35, 58, 125, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), Name = "AWS" },
                        new { Id = new Guid("0a07af89-3067-44ea-97f3-239ac831ac5c"), DateTimeCreated = new DateTimeOffset(new DateTime(2018, 8, 8, 10, 35, 58, 125, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), Name = "Azure" },
                        new { Id = new Guid("4dd52b8a-17b7-466d-88ff-2bd77c47afc2"), DateTimeCreated = new DateTimeOffset(new DateTime(2018, 8, 8, 10, 35, 58, 125, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), Name = "Google Cloud Platform" },
                        new { Id = new Guid("2fc3b71f-4188-4620-86f0-b7f445e89f88"), DateTimeCreated = new DateTimeOffset(new DateTime(2018, 8, 8, 10, 35, 58, 125, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), Name = "IBM" },
                        new { Id = new Guid("26352b58-0043-4b0f-9183-0bbe965db8a2"), DateTimeCreated = new DateTimeOffset(new DateTime(2018, 8, 8, 10, 35, 58, 125, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), Name = "Private Cloud" }
                    );
                });
