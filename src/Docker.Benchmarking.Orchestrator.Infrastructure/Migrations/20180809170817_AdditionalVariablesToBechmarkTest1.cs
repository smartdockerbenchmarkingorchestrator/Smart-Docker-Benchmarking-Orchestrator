...
{
    public partial class AdditionalVariablesToBechmarkTest1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                value: new DateTimeOffset(new DateTime(2018, 8, 9, 17, 8, 16, 772, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)));
