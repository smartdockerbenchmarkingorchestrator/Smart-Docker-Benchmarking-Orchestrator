...
namespace Docker.Benchmarking.Orchestrator.Infrastrcture.Migrations
{
    ...
    [Migration("20190107232349_VMSizetoAzureandAWSCloudTemplates")]
    partial class VMSizetoAzureandAWSCloudTemplates
    {
            ...
            modelBuilder.Entity("Docker.Benchmarking.Orchestrator.Core.Entities.AWSHost", b =>
                {
                    ...
                    b.Property<bool>("ResourceCreationStarted");

                    b.Property<bool>("ResourceDestroyed");

                    b.Property<DateTimeOffset>("ResourceDestroyedAt");

                    b.Property<bool>("ResourcedCreated");
            ...
            modelBuilder.Entity("Docker.Benchmarking.Orchestrator.Core.Entities.BenchmarkExperiment", b =>
                {
                    ...
                    b.Property<string>("BenchmarkingName");
